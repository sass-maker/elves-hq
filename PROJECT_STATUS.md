...
- The command-center frames active task rooms as Codex terminal drawers, with snapped drag resizing, local drawer-size persistence, focus mode for expanding one drawer into a large single terminal, and a compact drawer rail for switching.

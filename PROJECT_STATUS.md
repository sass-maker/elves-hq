...
- Command-center terminal polling refreshes room and decision state, so completed, failed, blocked, asking, and ready colors update from daemon state without reloading the cockpit.

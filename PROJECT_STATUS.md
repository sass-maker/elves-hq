...
- The cockpit opens to a terminal command-center start screen with active task terminal drawers paged into calm terminal bays, a visually distinct intervention pane for Needs Me signals, captured latest run/Codex stdout-stderr where available, and a direct path into the full room workbench.
